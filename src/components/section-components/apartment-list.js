                  ...
                  <div className="row align-items-center no-gutters">
                    <div className="col-lg-6">
                      <div className="room-thumb">
                        <img
                          src={publicUrl + "assets/img/apartment/01.jpg"}
                          alt="Room"
                        />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="room-desc">
                        ...
                        <ul className="room-info list-inline">
                          <li>
                            <i className="fas fa-bed" />2 Bed
                          </li>
                          <li>
                            <i className="fas fa-bath" />1 Baths
                          </li>
                          <li>
                ...
                <div className="single-room list-style Elevations-go-top">
                  <div className="row align-items-center no-gutters">
                    <div className="col-lg-6">
                      <div className="room-thumb">
                        <img
                          src={publicUrl + "assets/img/apartment/02.jpg"}
                          alt="Room"
                        />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="room-desc">
                        ...
                        <h4>
                          <Link to="/moredetails">Conference Room</Link>
                        </h4>
                        <ul className="room-info list-inline">
                          <li>
                            <i className="fas fa-bed" />3 Bed
                          </li>
                          <li>
                            <i className="fas fa-bath" />2 Baths
                          </li>
                          <li>
                            <i className="fas fa-ruler-combined" />
                            99 m
                ...
                <div className="single-room list-style Elevations-go-top">
                  <div className="row align-items-center no-gutters">
                    <div className="col-lg-6">
                      <div className="room-thumb">
                        <img
                          src={publicUrl + "assets/img/apartment/15.jpg"}
                          alt="Room"
                        />
                      </div>
                    </div>
                ...
                <div className="single-room list-style Elevations-go-top">
                  <div className="row align-items-center no-gutters">
                    <div className="col-lg-6">
                      <div className="room-thumb">
                        <img
                          src={publicUrl + "assets/img/apartment/19.jpg"}
                          alt="Room"
                        />
                      </div>
                    </div>
                ...
                <div className="single-room list-style Elevations-go-top">
                  <div className="row align-items-center no-gutters">
                    <div className="col-lg-6">
                      <div className="room-thumb">
                        <img
                          src={publicUrl + "assets/img/apartment/22.jpg"}
                          alt="Room"
                        />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="room-desc">
                        ...
                        <h4>
                          <Link to="/moredetails">Studio Apartment</Link>
                        </h4>
                        <ul className="room-info list-inline">
                          <li>
                            <i className="fas fa-bed" />1 Double Bed
                          </li>
                          <li>
                            <i className="fas fa-bath" />1 Baths
                          </li>
